...
#    da máquina coordenadora para todas as 8 outras máquinas.
...
# --- MAPA DA REDE ---
# Preencha com os 9 IPs REAIS das suas máquinas
...
# --- INÍCIO DA EXECUÇÃO ---
echo "AVISO: Este script irá iniciar 9 processos em 9 máquinas."
...
echo -e "\n[FASE 2/3] Iniciando 2 Supernós remotamente..."
...
echo -e "\n[FASE 3/3] Iniciando 6 Clientes remotamente..."
